...
### 8. Диаграммы потоков данных (DFD)
- Автоматизированная: `diagrams/dfd/automated/A3_lessons_dfd.puml`
- Неавтоматизированная: `diagrams/dfd/non-automated/A3_lessons_dfd.puml`
...
| DFD диаграммы (автоматизированная) | 1 | ✅ Выполнено |
| DFD диаграммы (неавтоматизированная) | 1 | ✅ Выполнено |
| DFD относится к конкретному процессу | A3 | ✅ Выполнено |
